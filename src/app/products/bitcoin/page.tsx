          ...
          <div className="grid grid-cols-3 mt-16 gap-8">
            <div className="flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-2">
                ...
                <p className="text-sm text-black-section font-normal">
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-2">
                ...
                <p className="text-sm text-black-section font-normal">
                  ...
                  your capital allocated to the asset are greater than the risk
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-2">
                ...
                <p className="text-sm text-black-section font-normal">
                  ...
                  cryptoactives is a way to directly expose yourself and invest
                  in innovation.
                </p>
              </div>
            </div>
        ...
        <div className="flex gap-20 w-full justify-between items-start">
          <div className="w-4/5">
            <h2 className="text-2xl text-black font-normal mb-5">
              What is{' '}
              <span className="text-blue text-2xl font-semibold">Bitcoin?</span>
            </h2>
            <p className="text-black-section font-normal text-sm">
