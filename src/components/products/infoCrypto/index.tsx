          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-2">
              <span className="text-black font-normal text-base text-left">
                {cryptoPoints.point1.title}
              </span>
              <p className="text-sm text-gray-000000b3 font-normal">
                {cryptoPoints.point1.description}
              </p>
            </div>
          </div>
          <div className="flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-2">
              <span className="text-black font-normal text-base text-left">
                {cryptoPoints.point2.title}
              </span>
              <p className="text-sm text-gray-000000b3 font-normal">
                {cryptoPoints.point2.description}
              </p>
            </div>
          </div>
          <div className="flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-2">
              <span className="text-black font-normal text-base text-left">
                {cryptoPoints.point3.title}
              </span>
              <p className="text-sm text-gray-000000b3 font-normal">
                {cryptoPoints.point3.description}
              </p>
            </div>
          </div>
        </div>
